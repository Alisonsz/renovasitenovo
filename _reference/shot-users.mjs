...
await p.setViewportSize({width:1366,height:880});
...
await p.goto('http://127.0.0.1:8000/admin/usuarios',{waitUntil:'networkidle'});
await p.waitForTimeout(800);
await p.screenshot({path:'_reference/screenshots/admin-users.jpg',type:'jpeg',quality:82});
await b.close();console.log('USERS_SHOT');
