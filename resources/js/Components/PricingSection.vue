    ...
    <section class="bg-[linear-gradient(180deg,#FFFFFF_0%,#DBE8E9_100%)] px-5 py-14 lg:py-[120px]">
        <div class="mx-auto max-w-[1140px]">
            ...
            <div class="relative mt-12">
                <ul
                    class="flex snap-x snap-mandatory gap-5 overflow-x-auto scroll-smooth px-0 pb-4 pl-10 pr-10 [scrollbar-width:none] lg:justify-center lg:overflow-visible lg:px-0"
                >
                    <li
                        v-for="card in PRICING"
                        :key="card.popup"
                        class="group flex w-[270px] shrink-0 snap-center flex-col overflow-hidden rounded-[12px] bg-white shadow-[0_0_10px_rgba(0,0,0,0.22)] transition duration-300 ease-out hover:-translate-y-[4px] hover:shadow-[0_12px_26px_rgba(0,0,0,0.18)] sm:w-[calc(50%-10px)] lg:w-[325px] lg:rounded-[8px]"
                    >
